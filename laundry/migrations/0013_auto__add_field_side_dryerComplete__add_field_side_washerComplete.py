...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Side.dryerComplete'
        db.add_column(u'laundry_side', 'dryerComplete',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Side.washerComplete'
        db.add_column(u'laundry_side', 'washerComplete',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Side.dryerComplete'
        db.delete_column(u'laundry_side', 'dryerComplete')

        # Deleting field 'Side.washerComplete'
        db.delete_column(u'laundry_side', 'washerComplete')

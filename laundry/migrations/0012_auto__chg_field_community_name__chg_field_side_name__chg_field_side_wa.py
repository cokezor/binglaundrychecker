...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Community.name'
        db.alter_column(u'laundry_community', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Side.name'
        db.alter_column(u'laundry_side', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
        ...
        db.alter_column(u'laundry_building', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Community.name'
        db.alter_column(u'laundry_community', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Side.name'
        db.alter_column(u'laundry_side', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
        ...
        # Changing field 'Building.name'
        db.alter_column(u'laundry_building', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
